		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="text" id="txt-nombre-contacto" name="txt-nombre-contacto"
					...
					data-bind="value: clienteViewModel.contacto.nombre"/>
			</div> 
		</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="text" id="txt-ape-pat-contacto" name="txt-ape-pat-contacto" 
					...
					data-bind="value: clienteViewModel.contacto.apellidoPaterno"/>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="text" id="txt-ape-mat-contacto" name="txt-ape-mat-contacto"
					...
					data-bind="value: clienteViewModel.contacto.apellidoMaterno"/>
			</div>
		</div>
	</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="text" id="txt-puesto-contacto" name="txt-puesto-contacto"
					...
					data-bind="value: clienteViewModel.contacto.puesto"/>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="email" id="txt-email-contacto" name="txt-email-contacto"
					...
					data-bind="value: clienteViewModel.contacto.email"/>
			</div>
		</div>
	</div>
</div>