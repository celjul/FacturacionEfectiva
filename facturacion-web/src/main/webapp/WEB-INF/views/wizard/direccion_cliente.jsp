		...
		<div class="col-md-4">
			<div class="form-group">
				<label for="txt-calle" class="required">Calle</label> <input
					...
					data-bind="value: clienteViewModel.direccion.calle" />
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="text" placeholder="No. Exterior" class="form-control"
					...
					data-bind="value: clienteViewModel.direccion.noExterior" />
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				<label for="txt-no-interior">No. Interior:</label> <input
					...
					data-bind="value: clienteViewModel.direccion.noInterior" />
			</div>
		</div>
	</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				<label for="txt-pais" class="required">País:</label> <input
					...
					data-bind="value: clienteViewModel.direccion.nombrePais">
			</div>
		</div>

		<div class="col-md-4">
			<div class="form-group">
				<label for="txt-estado" class="required">Estado:</label> <input
					type="text" placeholder="Estado" class="form-control"
					id="txt-estado" name="txt-estado" required="required"
					data-bind="value: clienteViewModel.direccion.nombreEstado" />
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="text" placeholder="Municipio" class="form-control"
					...
					data-bind="value: clienteViewModel.direccion.nombreMunicipio" /> </select>
			</div>
		</div>
	</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				<label for="txt-colonia" class="required">Colonia:</label> <input
					...
					data-bind="value: clienteViewModel.direccion.nombreColonia" />
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="form-group">
				<label for="txt-codigo-postal" class="required">Código
					...
					id="txt-codigo-postal" name="txt-codigo-postal"
					class="form-control" pattern="[0-9]{5}" maxlength="5"
					data-bind="value: clienteViewModel.direccion.codigoPostal" />
			</div>
		</div>
			...
			<div class="col-md-4">
				<div class="form-group">
					<label for="txt-localidad" class="required">Localidad:</label> <input
						...
						data-bind="value: clienteViewModel.direccion.localidad" />
				</div>
			</div>
		</c:if>
	</div>
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<textarea rows="3" cols="10" placeholder="Referencias"
					...
					data-bind="value: clienteViewModel.direccion.referencias"></textarea>
			</div>
		</div>
	</div>
</div>
