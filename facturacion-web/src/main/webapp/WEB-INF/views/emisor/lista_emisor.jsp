...
<html>
<head>
<title>Lista de Emisores</title>
<script src="${js}/app/emisores/emisores.list.app.js?version=${project.version}"></script>
</head>
<body>
	<div id="page-wrapper">
		<div class="row">
...
<!-- 										<td data-bind="text: id"></td> -->
										...
										<td class="text-center">
											<a class="btn btn-info" data-bind="attr: {href: String.format('{0}/app/emisores/{1}', contextPath, id)}">Editar</a>
										</td>
									</tr>
								</tbody>
							</table>
